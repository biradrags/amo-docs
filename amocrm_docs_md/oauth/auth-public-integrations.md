...
_В данный момент интеграции без виджетов не могут быть отображены в общем списке интеграций, но получаю больше возможностей по сравнению с приватными ([подробней о статусах](https://www.amocrm.ru/developers/content/platform/abilities))._
...
[Передача виджета на модерацию](https://www.amocrm.ru/developers/content/integrations/requirements)