<!-- https://www.amocrm.ru/developers/content/oauth/oauth-external-integrations -->
...
Подробней о параметрах можно прочитать на станице о функционале [Кнопки на сайт](/developers/content/oauth/button).
