<!-- https://www.amocrm.ru/developers/content/web_sdk/industry-solutions -->
...
### [Как подать заявку на разработку отраслевого решения](/web_sdk/industry-solutions#how-to-apply.html)
...
#### [Текст заявки:](/web_sdk/industry-solutions#application-text.html)

> Заявка на отраслевое решение от компании **НАЗВАНИЕ.**  
> Решение для **ОТРАСЛЬ** отрасли  
> Небольшое описание + ссылка на видео
...
### [Создание решения и тестирование](/web_sdk/industry-solutions#create-and-test.html)
...
### [Пример виджета](/web_sdk/industry-solutions#example-widget.html)
...
### [Не запускать тур amoCRM](/web_sdk/industry-solutions#dont-start-tour.html)
...
### [Правила:](/web_sdk/industry-solutions#rules.html)
...
### [Как отправить отраслевое решение на модерацию](/web_sdk/industry-solutions#how-to-submit.html)
...
Отраслевое решение является публичной интеграцией, поэтому при его разработке обязательно необходимо соблюдать [требования к публичным интеграциям](/integrations/requirements.html)

### [После публикации отраслевого решения](/web_sdk/industry-solutions#after-publication.html)
...
Пример: [https://www.amocrm.ru/?crm\_template=код](https://www.amocrm.ru/?crm_template=код) отраслевого решения