...
*   [Название сущности, в которой находимся](/web_sdk/env_variables#base-entity.html)
*   [Проверить факт нахождения в карточке](/web_sdk/env_variables#is-card.html)
*   [Получить код текущей страницы](/web_sdk/env_variables#widget-area.html)
*   [Определить язык, установленный в профиле пользователя](/web_sdk/env_variables#lang.html)
*   [Получить/установить значение константы](/web_sdk/env_variables#constant.html)
*   [Обращение к данным на странице](/web_sdk/env_variables#page-data.html)
...
| widget-page:\_\_\_DOUBLE\_OPEN\_BRACE\_\_\_code\_\_\_DOUBLE\_CLOSE\_BRACE\_\_\_ | Страница виджета, добавляемая в левое меню |
| settings | Страницы "Профиль", "Счет и оплата" и "Общие настройки" раздела "Настройки" |
| advanced-settings:\_\_\_DOUBLE\_OPEN\_BRACE\_\_\_code\_\_\_DOUBLE\_CLOSE\_BRACE\_\_\_ | Расширенные настройки виджета |
