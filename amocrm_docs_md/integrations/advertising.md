...
— Баннер в конкретной категории – 200 000 руб/мес;  
— "Рекомендации дня" в разделе "Выбор amoCRM" – 50 000 руб/нед;  
— "Рекомендации дня" в категории – 25 000 руб/нед.  
Одна интеграция может покупать места в разных категориях одновременно.  
Если вдруг выбранное размещение уже занято, то вам будут предложены ближайшие свободные даты.
