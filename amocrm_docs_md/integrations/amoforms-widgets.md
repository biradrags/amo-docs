...
Чтобы существующий или новый виджет начал поддерживать функционал работы в веб-формах, вам необходимо добавить новый объект amoforms\_settings и указать дополнительный location amoforms в [файле manifest.json](/integrations/structure#manifest.html).
