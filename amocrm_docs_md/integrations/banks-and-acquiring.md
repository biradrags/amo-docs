<!-- https://www.amocrm.ru/developers/content/integrations/banks-and-acquiring -->
...
Для создания интеграции с поддержкой эквайрингов вам нужно [создать](/integrations/intro#registration.html) технический аккаунт или использовать сущесствующий.
