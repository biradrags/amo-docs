<!-- https://www.amocrm.ru/developers/content/integrations/requirements -->

# Требования к публичным интеграциям

### Оглавление

*   [Свод правил для Интеграторов](/integrations/requirements#1-%D0%A1%D0%B2%D0%BE%D0%B4-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB-%D0%B4%D0%BB%D1%8F-%D0%98%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.html)
*   [Формирование задачи](/integrations/requirements#2-%D0%A4%D0%BE%D1%80%D0%BC%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D0%B8.html)
*   [Разработка интеграции](/integrations/requirements#3-%D0%A0%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D0%B0-%D0%B8%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D0%B8.html)
*   [Публикация в маркетплейс](/integrations/requirements#4-%D0%9F%D1%83%D0%B1%D0%BB%D0%B8%D0%BA%D0%B0%D1%86%D0%B8%D1%8F-%D0%B2-%D0%BC%D0%B0%D1%80%D0%BA%D0%B5%D1%82%D0%BF%D0%BB%D0%B5%D0%B9%D1%81.html)
...
*   Интеграция не должна изменять интерфейсы, которые не включены в [разрешенный список](/integrations/areas.html).
*   Запрещено изменение левого меню, кроме случаев, описанных в [документации](/web_sdk/left_menu.html).
...
*   При добавлении [дополнительной страницы расширенных настроек виджета](/web_sdk/left_menu.html) в разделе "Настройки", название страницы не должно повторять названия стандартных страниц, то есть вводить в заблуждение неподготовленного пользователя.
...
*   В коде интеграции не должно быть следующего:
    *   тестовых данных
    *   дебагов, за исключением случаев описанных [ниже](/integrations/requirements#logging.html)
...
*   Виджет не должен влиять на данные в глобальной переменной AMOCRM, он может только читать данные оттуда. Список допустимых обращений описан в статье ["Переменные окружения"](/web_sdk/env_variables.html). Мы не гарантируем работу недокументированных переменных окружения в будущем, поэтому настоятельно рекомендуем отказаться от их использования.
...
*   Файлы со стилями должны подключаться строго в соответствии с [документацией](/integrations/script_js.html).
...
*   Вы можете использовать html разметку в описании интеграции, при этом необходимо соблюдать следующие правила:
    *   Все ссылки должны быть оформлены в виде [html тега `<a>](http://htmlbook.ru/html/a), например <a href="[https://amocrm.ru](https://amocrm.ru)" target="\_blank" referrerpolicy="no-referrer">amoCRM</a>`
...
*   Если интеграция подразумевает какой-либо способ оплаты или действия со стороны клиента – необходимо выставить у интеграции “Внешняя оплата“.
*   Стоимость интеграции и тарифы должны быть указаны в описаниях как до, так и после установки. В описании после установки допустимо приложить ссылку или кнопку на сайт, где пользователь может ознакомиться с ее стоимостью. Если сайта нет, то это должно быть прописано именно в описании.
*   Не допускается использовать “Бесплатно“ при указании триального периода интеграции, если таковой имеется.

> Нельзя  
> Подключи бесплатно на 7 дней
> 
> Можно  
> Подключи пробный период на 7 дней