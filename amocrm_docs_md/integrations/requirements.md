...
* Вы можете использовать html разметку в описании интеграции, при этом необходимо соблюдать следующие правила:
  + Все ссылки должны быть оформлены в виде [html тега <a>](http://htmlbook.ru/html/a), например <a href="<https://amocrm.ru>" target="\_blank" referrerpolicy="no-referrer">amoCRM</a>
