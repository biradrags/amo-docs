...
Для этого необходимо в списке [областей подключения](/integrations/areas.html) виджета указать область advanced\_settings. На данной странице у виджета будет срабатывать callback advancedSettings.
...
[JS SDK](/integrations/js_sdk.html)