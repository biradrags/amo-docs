<!-- https://www.amocrm.ru/developers/content/integrations/upload -->
...
Затем зайти в amoCRM в раздел **амоМаркет**, где мы уже [создавали ранее интеграцию](/oauth/step-by-step.html), переходим в режим редактирования и загружаем наш архив в соответствующее поле.
...
Подробнее с требованиями к публичным виджетам вы можете ознакомиться в этой [статье](/integrations/requirements.html).

[Расширенные настройки](/integrations/custom_settings.html)