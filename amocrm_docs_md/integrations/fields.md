...
[Расширенные настройки виджета](/integrations/custom_settings.html). |
...
Так же существует возможность добавлять пользовательские поля типа custom. Эта возможность подробно рассмотрена в разделе [Расширенные настройки виджета](/integrations/custom_settings.html)

[JS-Виджет](/integrations/script_js.html)