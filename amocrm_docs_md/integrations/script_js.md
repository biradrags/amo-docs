...
| dpSettings: | Метод callbacks.dpSettings аналогичен callbacks.settings, но вызывается в области видимости digital\_pipeline (подробнее [Digital pipeline](/digital_pipeline/integrations.html)) |
...
Для добавления тура в модальное окно виджета необходимо добавить свойство tour в manifest.json. Подробней об этом читайте в [этой статье](/integrations/structure#manifest_example.html).
