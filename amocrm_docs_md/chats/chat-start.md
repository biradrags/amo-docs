...
2.  Webhook URL, на который будут присылаться сообщения из amoCRM. URL должен быть вида [https://domain.com/location/:scope\_id](https://domain.com/location/:scope_id).  
