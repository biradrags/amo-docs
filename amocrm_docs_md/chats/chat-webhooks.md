...
*   [Хук об ответе на комментарий](#Хук-об-ответе-на-комментарий)
...
| message\[timestamp\] | int | Время сообщения, метка unix |
| message\[msec\_timestamp\] | int | Время сообщения, метка unix c миллисекундами |
| message\[message\] | object | Объект с информацией об отправляемом сообщении. [Описание объекта](#Структура-объекта-message) |
...
| post | object | Объект поста к которому был написан комменатирий на который отправлен ответ. [Структура объекта post](#Структура-объекта-post) |
| reply\_to | object | Объект цитаты-ответа. [Структура объекта цитирования](#Структура-объекта-цитаты-с-ответом) |
